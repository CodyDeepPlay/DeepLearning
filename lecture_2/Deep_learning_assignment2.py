# -*- coding: utf-8 -*-
"""
Created on Tue Aug 21 22:35:05 2018
...
graph = tf.Graph()   # a tensor flow graph object
with graph.as_default():
  ...
  biases = tf.Variable(tf.zeros([num_labels]))  # add a variable to the graph
...
#%% switch to stochastic gradient descent training instead, and it is much faster
batch_size = 128
